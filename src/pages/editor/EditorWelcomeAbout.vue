...
<template>
  <div class="flex h-full flex-col justify-between space-y-4">
    <div class="flex flex-col space-y-4">
      ...
      <div class="flex max-w-lg flex-col items-start space-y-2 text-xl">
        <Lang class="flex flex-col space-y-2.5">
          <template #zh>
            <p><b>谜墨编辑器</b>是嵌入在浏览器中的文本编辑器。</p>

            <p>
              它可以访问用户的本地文件系统，并且预览 Mimor 和 Markdown 文件。
            </p>

            <p>目前支持 Chrome、Edge 和 Opera 等基于 Chromium 的浏览器。</p>
          </template>
          <template #en>
            <p><b>Mimor Editor</b> is a text editor embedded in the browser.</p>

            <p>
              It can access user's local file system, and preview Mimor and
              Markdown files.
            </p>
    ...
    <div class="flex flex-col items-start space-y-2">
      <Lang class="text-stone-500 dark:text-stone-400">
        <template #zh>
