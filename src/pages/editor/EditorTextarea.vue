...
<template>
  <textarea
    ref="rootElement"
    class="scrollbar-w-8 scrollbar-h-8 h-full w-full resize-none whitespace-pre bg-white px-3 py-2 font-mono text-black caret-red-500 focus:outline-none dark:bg-stone-900 dark:text-white"
    spellcheck="false"
    v-model="tab.text"
